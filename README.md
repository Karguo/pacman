...
This is written in Ruby for the IE Coding Challenge.

Tests written using RSpec. 

Many thanks to Google and Stack Overflow and documentations. 

## Usage

To run app: bundle exec ruby exe/pacman commands.txt
